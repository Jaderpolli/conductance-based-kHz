...
bifurcation_file = "./04_hh3D.dat"
ISI_file = "../../../../results/raw/mdl_properties/ISI_HH3D.txt"
...
def read_xppdat(filename_bifurcation, filename_ISI):
    ...
    unstable_Imin = 8.425 # np.min(unstable_Istim)
    ...
    ax[0].grid()
    fig.suptitle(r"3D-$h$-reduced HH")

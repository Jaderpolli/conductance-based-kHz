...
bifurcation_file = "./03_hh2D.dat"
ISI_file = "../../../../results/raw/mdl_properties/ISI_HH2D.txt"
...
def read_xppdat(filename_bifurcation, filename_ISI):
    ...
    unstable_Imin = 6.845 #np.min(unstable_Istim)

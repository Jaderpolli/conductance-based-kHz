...
bifurcation_file = "./13_Hipp_Inh_Wang_Buzsaki.dat"
ISI_file = "../../../../results/raw/mdl_properties/ISI_WangBuszaki.txt"
...
def read_xppdat(filename_bifurcation, filename_ISI):
    ...
    ax[0].grid()
    fig.suptitle("Basket Inhibitory model")
    ...
    ax[1].plot(curve_stable_1_Istim, curve_stable_1_V_eq, c="red")
    ax[1].plot(curve_stable_2_Istim, curve_stable_2_V_eq, label="Stable Eq.", c="red")
    ...
    fig.tight_layout()
    fig.savefig('13_Hipp_Inh_Wang_Buzsaki.pdf')
    plt.show()

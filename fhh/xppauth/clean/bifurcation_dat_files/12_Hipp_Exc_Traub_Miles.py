...
bifurcation_file = "./12_Hipp_Exc_Traub_Miles.dat"
ISI_file = "../../../../results/raw/mdl_properties/ISI_Traub_Miles_2.txt"
...
def read_xppdat(filename_bifurcation, filename_ISI):
    ...
    unstable_Imin = 0 # np.min(unstable_Istim)
    unstable_Imax = 117
    stable_C1max = 1
    stable_C2min = 110
    ...
    ax[0].grid()
    fig.suptitle("Pyramidal Excitatory model")
    ...
    fig.tight_layout()
    fig.savefig('12_Hipp_Exc_Traub_Miles.pdf')
    plt.show()
